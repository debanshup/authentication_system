...
export default function Page() {
  ...
  async function getDetails() {
    try {
      ...
      if (detailsRes.data.success) {
        ...
        setPermanentUsername(detailsRes.data.props.profile.username)
        setUser({username: detailsRes.data.props.profile.username})
        // alert(permanentUsername)
        setProfile({
          ...
          username: detailsRes.data.props.profile.username,
        });
      } else {
  ...
  return (
    ...
    <>
      {/* <Toaster /> */}
      <RootLayout username={permanentUsername} fullname={"fullname"} imagesrc={"image"} >
        {isErrorOccured ? <>
