...
const Page = () => {
  ...
  return (
    <>
      ...
      <div className="mt-4">
  <div className="p-4 rounded shadow-sm" style={{ backgroundColor: "#f8f9fa", border: "1px solid #ddd" }}>
    {/* Change Username */}
    <div className="mb-5">
      <h5 className="fw-bold text-dark">Change Username</h5>
      <p className="text-muted small">You can update your username to personalize your profile.</p>
      <button 
    ...
    <div className="mb-5">
      ...
      <p className="text-muted small">Modify your email address used for login and communications.</p>
      <button 
        className="btn btn-sm btn-dark" 
    ...
    <div className="mb-5">
      ...
      <p className="text-muted small">Set a new password to strengthen your account's security.</p>
      <button 
        className="btn btn-sm btn-dark" 
    ...
    {/* Delete Account */}
    <div className="p-4 mt-5 rounded" style={{ backgroundColor: "#fff3f3", border: "1px solid #dc3545" }}>
      <h5 className="fw-bold text-danger">Delete Account</h5>
      <p className="text-danger small">
        <strong>Warning:</strong> This action is **permanent**. Once your account is deleted, it cannot be recovered.
      </p>
      <p className="text-muted small">If you are sure, proceed with the deletion.</p>
      <button 
